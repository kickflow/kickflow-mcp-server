...
export const ListWorkflowsResponseItem = zod.object({
  ...
  "publicTicket": zod.boolean().default(listWorkflowsResponsePublicTicketDefault).describe('チケットがテナント全体に共有される場合true'),
  "visibleToManager": zod.enum(['none', 'direct', 'all']).describe('申請者の上長を共有ユーザーに追加するか。noneは追加しない、directは直属の上長のみ、allはすべての上長を表す。'),
  "visibleToTeamMembers": zod.boolean().default(listWorkflowsResponseVisibleToTeamMembersDefault).describe('申請チームのメンバーが共有ユーザーに追加される場合true'),
  ...
  "email": zod.email().max(listWorkflowsResponseAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(listWorkflowsResponseAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(listWorkflowsResponseAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(listWorkflowsResponseAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(listWorkflowsResponseAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(listWorkflowsResponseAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  ...
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(listWorkflowsResponseVersionAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(listWorkflowsResponseVersionAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(listWorkflowsResponseVersionAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(listWorkflowsResponseVersionAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(listWorkflowsResponseVersionAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(listWorkflowsResponseVersionAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "folder": zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(listWorkflowsResponseFolderOneNameMax).describe('名前'),
  "code": zod.string().max(listWorkflowsResponseFolderOneCodeMax).describe('コード'),
  "description": zod.string().nullish().describe('説明'),
  "workflowsCount": zod.number().min(listWorkflowsResponseFolderOneWorkflowsCountMin).describe('フォルダ内のワークフロー数'),
  "routesCount": zod.number().min(listWorkflowsResponseFolderOneRoutesCountMin).describe('フォルダ内の経路数'),
  "pipelinesCount": zod.number().min(listWorkflowsResponseFolderOnePipelinesCountMin).describe('フォルダ内のパイプライン数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
...
export const GetWorkflowResponse = zod.object({
  "id": zod.string().describe('UUID'),
  "code": zod.string().regex(getWorkflowResponseOneOneCodeRegExp).describe('コード'),
  "versionId": zod.string().describe('バージョンのUUID'),
  "versionNumber": zod.number().describe('バージョン番号'),
  "name": zod.string().describe('名前'),
  "description": zod.string().describe('説明'),
  "status": zod.enum(['visible', 'invisible', 'deleted']).describe('ステータス。visibleは有効、invisibleは無効、deletedは削除済み。'),
  "publicTicket": zod.boolean().default(getWorkflowResponseOneOnePublicTicketDefault).describe('チケットがテナント全体に共有される場合true'),
  "visibleToManager": zod.enum(['none', 'direct', 'all']).describe('申請者の上長を共有ユーザーに追加するか。noneは追加しない、directは直属の上長のみ、allはすべての上長を表す。'),
  "visibleToTeamMembers": zod.boolean().default(getWorkflowResponseOneOneVisibleToTeamMembersDefault).describe('申請チームのメンバーが共有ユーザーに追加される場合true'),
  "titleDescription": zod.string().nullable().describe('タイトルの説明'),
  "ticketNumberFormat": zod.string().nullable().describe('チケット番号のフォーマット'),
  "overwritable": zod.boolean().describe('承認者による上書きが可能な場合true'),
  "createdAt": zod.string().describe('作成日時'),
  ...
  "titleInputMode": zod.enum(['none', 'input', 'calculate']).describe('タイトル入力モード'),
  "titleFormula": zod.string().nullable().describe('タイトルの計算式'),
  "allowEditingOfViewers": zod.boolean().default(getWorkflowResponseOneOneAllowEditingOfViewersDefault).describe('共有ユーザーの編集が可能な場合true'),
  "author": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(getWorkflowResponseOneOneAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(getWorkflowResponseOneOneAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(getWorkflowResponseOneOneAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(getWorkflowResponseOneOneAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(getWorkflowResponseOneOneAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(getWorkflowResponseOneOneAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "versionAuthor": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(getWorkflowResponseOneOneVersionAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(getWorkflowResponseOneOneVersionAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(getWorkflowResponseOneOneVersionAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(getWorkflowResponseOneOneVersionAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(getWorkflowResponseOneOneVersionAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(getWorkflowResponseOneOneVersionAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "folder": zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getWorkflowResponseOneOneFolderOneNameMax).describe('名前'),
  "code": zod.string().max(getWorkflowResponseOneOneFolderOneCodeMax).describe('コード'),
  "description": zod.string().nullish().describe('説明'),
  "workflowsCount": zod.number().min(getWorkflowResponseOneOneFolderOneWorkflowsCountMin).describe('フォルダ内のワークフロー数'),
  "routesCount": zod.number().min(getWorkflowResponseOneOneFolderOneRoutesCountMin).describe('フォルダ内の経路数'),
  "pipelinesCount": zod.number().min(getWorkflowResponseOneOneFolderOnePipelinesCountMin).describe('フォルダ内のパイプライン数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('フォルダ').describe('フォルダ'),
  "categories": zod.array(zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getWorkflowResponseOneOneCategoriesItemNameMax).describe('名前'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('カテゴリ')).describe('カテゴリの配列')
  ...
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemOneTitleMax).describe('説明'),
  "description": zod.string().nullable().describe('説明'),
  ...
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemOneCodeMax).describe('コード'),
  ...
  "minLength": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemOneMinLengthMin).nullable().describe('最小文字数'),
  "maxLength": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemOneMaxLengthMin).nullable().describe('最大文字数'),
  "decimalDigit": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemOneDecimalDigitMin).nullable().describe('小数の桁数'),
  ...
  "id": zod.uuid().describe('UUID'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoGeneralMasterOneCodeMax).describe('コード'),
  "name": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoGeneralMasterOneNameMax).describe('名前'),
  "description": zod.string().nullable().describe('説明'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時'),
  "fields": zod.array(zod.object({
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoGeneralMasterOneFieldsItemTitleMax).describe('フィールド名'),
  "description": zod.string().nullable().describe('フィールドの説明'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoGeneralMasterOneFieldsItemCodeMax).describe('フィールドのコード'),
  ...
  "id": zod.uuid().describe('UUID'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoDefaultGeneralMasterItemOneCodeMax).describe('コード'),
  "name": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoDefaultGeneralMasterItemOneNameMax).describe('名前'),
  "description": zod.string().nullable().describe('説明'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時'),
  ...
  "field": zod.object({
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoDefaultGeneralMasterItemOneInputsItemFieldTitleMax).describe('フィールド名'),
  "description": zod.string().nullable().describe('フィールドの説明'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoDefaultGeneralMasterItemOneInputsItemFieldCodeMax).describe('フィールドのコード'),
  "fieldType": zod.enum(['text', 'text_long', 'number', 'integer', 'checkbox', 'pull_down', 'date']).describe('フィールドの型'),
  "required": zod.boolean().describe('必須項目かどうか'),
  "visible": zod.boolean().describe('管理者以外も閲覧可能な場合true'),
  "options": zod.array(zod.string()).nullable().describe('選択肢。fieldTypeがcheckboxまたはpull_downのときのみ。'),
  ...
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoExternalApiSettingOneMappingsItemFormFieldTitleMax).describe('説明'),
  "description": zod.string().nullable().describe('説明'),
  "fieldType": zod.enum(['text', 'text_long', 'number', 'integer', 'checkbox', 'pull_down', 'date', 'file', 'master', 'user', 'team', 'ticket', 'calculation', 'button_api', 'button_kintone']).describe('フィールドの型'),
  "required": zod.boolean().describe('必須項目かどうか'),
  "approver": zod.boolean().describe('承認者が編集可能かどうか'),
  "author": zod.boolean().optional().describe('申請者が編集可能かどうか'),
  "options": zod.array(zod.string()).nullable().describe('選択肢のリスト。型がcheckboxまたはpull_downのときのみ値が入ります。'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoExternalApiSettingOneMappingsItemFormFieldCodeMax).describe('コード'),
  "size": zod.enum(['full', 'half']).describe('フォームサイズ。fullの場合全幅、halfの場合1\/2になります。'),
  "regexpFormat": zod.string().nullable().describe('正規表現フォーマット'),
  "formula": zod.string().nullable().describe('計算式。\n型がcalculationのときのみ値が入ります。'),
  "defaultValue": zod.string().nullable().describe('初期値'),
  "minValue": zod.number().nullable().describe('最小値'),
  "maxValue": zod.number().nullable().describe('最大値'),
  "minLength": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoExternalApiSettingOneMappingsItemFormFieldMinLengthMin).nullable().describe('最小文字数'),
  "maxLength": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoExternalApiSettingOneMappingsItemFormFieldMaxLengthMin).nullable().describe('最大文字数'),
  "decimalDigit": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoExternalApiSettingOneMappingsItemFormFieldDecimalDigitMin).nullable().describe('小数の桁数'),
  "delimited": zod.boolean().nullable().describe('カンマ区切りで表示する場合true。\n整数、数値、自動計算フィールド以外ではnullが入ります。'),
  "prefix": zod.string().nullable().describe('単位（接頭辞）'),
  "suffix": zod.string().nullable().describe('単位（接尾辞）'),
  "hidden": zod.boolean().nullish().describe('隠しフィールドである場合true'),
  ...
  "formField": zod.object({
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoKintoneAppSettingOneFormFieldTitleMax).describe('説明'),
  "description": zod.string().nullable().describe('説明'),
  "fieldType": zod.enum(['text', 'text_long', 'number', 'integer', 'checkbox', 'pull_down', 'date', 'file', 'master', 'user', 'team', 'ticket', 'calculation', 'button_api', 'button_kintone']).describe('フィールドの型'),
  "required": zod.boolean().describe('必須項目かどうか'),
  "approver": zod.boolean().describe('承認者が編集可能かどうか'),
  "author": zod.boolean().optional().describe('申請者が編集可能かどうか'),
  "options": zod.array(zod.string()).nullable().describe('選択肢のリスト。型がcheckboxまたはpull_downのときのみ値が入ります。'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoKintoneAppSettingOneFormFieldCodeMax).describe('コード'),
  "size": zod.enum(['full', 'half']).describe('フォームサイズ。fullの場合全幅、halfの場合1\/2になります。'),
  "regexpFormat": zod.string().nullable().describe('正規表現フォーマット'),
  "formula": zod.string().nullable().describe('計算式。\n型がcalculationのときのみ値が入ります。'),
  "defaultValue": zod.string().nullable().describe('初期値'),
  "minValue": zod.number().nullable().describe('最小値'),
  "maxValue": zod.number().nullable().describe('最大値'),
  "minLength": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoKintoneAppSettingOneFormFieldMinLengthMin).nullable().describe('最小文字数'),
  "maxLength": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoKintoneAppSettingOneFormFieldMaxLengthMin).nullable().describe('最大文字数'),
  "decimalDigit": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoKintoneAppSettingOneFormFieldDecimalDigitMin).nullable().describe('小数の桁数'),
  "delimited": zod.boolean().nullable().describe('カンマ区切りで表示する場合true。\n整数、数値、自動計算フィールド以外ではnullが入ります。'),
  "prefix": zod.string().nullable().describe('単位（接頭辞）'),
  "suffix": zod.string().nullable().describe('単位（接尾辞）'),
  "hidden": zod.boolean().nullish().describe('隠しフィールドである場合true'),
  ...
  "formField": zod.object({
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoKintoneAppSettingOneMappingsItemFormFieldTitleMax).describe('説明'),
  "description": zod.string().nullable().describe('説明'),
  "fieldType": zod.enum(['text', 'text_long', 'number', 'integer', 'checkbox', 'pull_down', 'date', 'file', 'master', 'user', 'team', 'ticket', 'calculation', 'button_api', 'button_kintone']).describe('フィールドの型'),
  "required": zod.boolean().describe('必須項目かどうか'),
  "approver": zod.boolean().describe('承認者が編集可能かどうか'),
  "author": zod.boolean().optional().describe('申請者が編集可能かどうか'),
  "options": zod.array(zod.string()).nullable().describe('選択肢のリスト。型がcheckboxまたはpull_downのときのみ値が入ります。'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoKintoneAppSettingOneMappingsItemFormFieldCodeMax).describe('コード'),
  "size": zod.enum(['full', 'half']).describe('フォームサイズ。fullの場合全幅、halfの場合1\/2になります。'),
  "regexpFormat": zod.string().nullable().describe('正規表現フォーマット'),
  "formula": zod.string().nullable().describe('計算式。\n型がcalculationのときのみ値が入ります。'),
  "defaultValue": zod.string().nullable().describe('初期値'),
  "minValue": zod.number().nullable().describe('最小値'),
  "maxValue": zod.number().nullable().describe('最大値'),
  "minLength": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoKintoneAppSettingOneMappingsItemFormFieldMinLengthMin).nullable().describe('最小文字数'),
  "maxLength": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoKintoneAppSettingOneMappingsItemFormFieldMaxLengthMin).nullable().describe('最大文字数'),
  "decimalDigit": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoKintoneAppSettingOneMappingsItemFormFieldDecimalDigitMin).nullable().describe('小数の桁数'),
  "delimited": zod.boolean().nullable().describe('カンマ区切りで表示する場合true。\n整数、数値、自動計算フィールド以外ではnullが入ります。'),
  "prefix": zod.string().nullable().describe('単位（接頭辞）'),
  "suffix": zod.string().nullable().describe('単位（接尾辞）'),
  "hidden": zod.boolean().nullish().describe('隠しフィールドである場合true'),
  ...
  "formField": zod.object({
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoClimberCloudSettingOneFormFieldTitleMax).describe('説明'),
  "description": zod.string().nullable().describe('説明'),
  "fieldType": zod.enum(['text', 'text_long', 'number', 'integer', 'checkbox', 'pull_down', 'date', 'file', 'master', 'user', 'team', 'ticket', 'calculation', 'button_api', 'button_kintone']).describe('フィールドの型'),
  "required": zod.boolean().describe('必須項目かどうか'),
  "approver": zod.boolean().describe('承認者が編集可能かどうか'),
  "author": zod.boolean().optional().describe('申請者が編集可能かどうか'),
  "options": zod.array(zod.string()).nullable().describe('選択肢のリスト。型がcheckboxまたはpull_downのときのみ値が入ります。'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoClimberCloudSettingOneFormFieldCodeMax).describe('コード'),
  "size": zod.enum(['full', 'half']).describe('フォームサイズ。fullの場合全幅、halfの場合1\/2になります。'),
  "regexpFormat": zod.string().nullable().describe('正規表現フォーマット'),
  "formula": zod.string().nullable().describe('計算式。\n型がcalculationのときのみ値が入ります。'),
  "defaultValue": zod.string().nullable().describe('初期値'),
  "minValue": zod.number().nullable().describe('最小値'),
  "maxValue": zod.number().nullable().describe('最大値'),
  "minLength": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoClimberCloudSettingOneFormFieldMinLengthMin).nullable().describe('最小文字数'),
  "maxLength": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoClimberCloudSettingOneFormFieldMaxLengthMin).nullable().describe('最大文字数'),
  "decimalDigit": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoClimberCloudSettingOneFormFieldDecimalDigitMin).nullable().describe('小数の桁数'),
  "delimited": zod.boolean().nullable().describe('カンマ区切りで表示する場合true。\n整数、数値、自動計算フィールド以外ではnullが入ります。'),
  "prefix": zod.string().nullable().describe('単位（接頭辞）'),
  "suffix": zod.string().nullable().describe('単位（接尾辞）'),
  "hidden": zod.boolean().nullish().describe('隠しフィールドである場合true'),
  ...
  "formField": zod.object({
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoClimberCloudSettingOneMappingsItemFormFieldTitleMax).describe('説明'),
  "description": zod.string().nullable().describe('説明'),
  "fieldType": zod.enum(['text', 'text_long', 'number', 'integer', 'checkbox', 'pull_down', 'date', 'file', 'master', 'user', 'team', 'ticket', 'calculation', 'button_api', 'button_kintone']).describe('フィールドの型'),
  "required": zod.boolean().describe('必須項目かどうか'),
  "approver": zod.boolean().describe('承認者が編集可能かどうか'),
  "author": zod.boolean().optional().describe('申請者が編集可能かどうか'),
  "options": zod.array(zod.string()).nullable().describe('選択肢のリスト。型がcheckboxまたはpull_downのときのみ値が入ります。'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoClimberCloudSettingOneMappingsItemFormFieldCodeMax).describe('コード'),
  "size": zod.enum(['full', 'half']).describe('フォームサイズ。fullの場合全幅、halfの場合1\/2になります。'),
  "regexpFormat": zod.string().nullable().describe('正規表現フォーマット'),
  "formula": zod.string().nullable().describe('計算式。\n型がcalculationのときのみ値が入ります。'),
  "defaultValue": zod.string().nullable().describe('初期値'),
  "minValue": zod.number().nullable().describe('最小値'),
  "maxValue": zod.number().nullable().describe('最大値'),
  "minLength": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoClimberCloudSettingOneMappingsItemFormFieldMinLengthMin).nullable().describe('最小文字数'),
  "maxLength": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoClimberCloudSettingOneMappingsItemFormFieldMaxLengthMin).nullable().describe('最大文字数'),
  "decimalDigit": zod.number().min(getWorkflowResponseOneTwoSectionListItemFormFieldsItemTwoClimberCloudSettingOneMappingsItemFormFieldDecimalDigitMin).nullable().describe('小数の桁数'),
  "delimited": zod.boolean().nullable().describe('カンマ区切りで表示する場合true。\n整数、数値、自動計算フィールド以外ではnullが入ります。'),
  "prefix": zod.string().nullable().describe('単位（接頭辞）'),
  "suffix": zod.string().nullable().describe('単位（接尾辞）'),
  "hidden": zod.boolean().nullish().describe('隠しフィールドである場合true'),
  ...
  "generalMaster": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemSlipFieldsItemTwoGeneralMasterOneCodeMax).describe('コード'),
  "name": zod.string().max(getWorkflowResponseOneTwoSectionListItemSlipFieldsItemTwoGeneralMasterOneNameMax).describe('名前'),
  "description": zod.string().nullable().describe('説明'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時'),
  "fields": zod.array(zod.object({
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getWorkflowResponseOneTwoSectionListItemSlipFieldsItemTwoGeneralMasterOneFieldsItemTitleMax).describe('フィールド名'),
  "description": zod.string().nullable().describe('フィールドの説明'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemSlipFieldsItemTwoGeneralMasterOneFieldsItemCodeMax).describe('フィールドのコード'),
  "fieldType": zod.enum(['text', 'text_long', 'number', 'integer', 'checkbox', 'pull_down', 'date']).describe('フィールドの型'),
  "required": zod.boolean().describe('必須項目かどうか'),
  "visible": zod.boolean().describe('管理者以外も閲覧可能な場合true'),
  "options": zod.array(zod.string()).nullable().describe('選択肢。fieldTypeがcheckboxまたはpull_downのときのみ。'),
  ...
  "defaultGeneralMasterItem": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemSlipFieldsItemTwoDefaultGeneralMasterItemOneCodeMax).describe('コード'),
  "name": zod.string().max(getWorkflowResponseOneTwoSectionListItemSlipFieldsItemTwoDefaultGeneralMasterItemOneNameMax).describe('名前'),
  "description": zod.string().nullable().describe('説明'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時'),
  "startsOn": zod.iso.date().nullable().describe('有効期限の開始日'),
  ...
  "field": zod.object({
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getWorkflowResponseOneTwoSectionListItemSlipFieldsItemTwoDefaultGeneralMasterItemOneInputsItemFieldTitleMax).describe('フィールド名'),
  "description": zod.string().nullable().describe('フィールドの説明'),
  "code": zod.string().max(getWorkflowResponseOneTwoSectionListItemSlipFieldsItemTwoDefaultGeneralMasterItemOneInputsItemFieldCodeMax).describe('フィールドのコード'),
  "fieldType": zod.enum(['text', 'text_long', 'number', 'integer', 'checkbox', 'pull_down', 'date']).describe('フィールドの型'),
  "required": zod.boolean().describe('必須項目かどうか'),
  "visible": zod.boolean().describe('管理者以外も閲覧可能な場合true'),
  "options": zod.array(zod.string()).nullable().describe('選択肢。fieldTypeがcheckboxまたはpull_downのときのみ。'),
  ...
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(getWorkflowResponseOneTwoTicketViewersItemUserOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(getWorkflowResponseOneTwoTicketViewersItemUserOneCodeMax).describe('コード'),
  "firstName": zod.string().max(getWorkflowResponseOneTwoTicketViewersItemUserOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(getWorkflowResponseOneTwoTicketViewersItemUserOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(getWorkflowResponseOneTwoTicketViewersItemUserOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(getWorkflowResponseOneTwoTicketViewersItemUserOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getWorkflowResponseOneTwoTicketViewersItemTeamOneNameMax).describe('名前'),
  "fullName": zod.string().describe('上位組織を含む名前'),
  "code": zod.string().max(getWorkflowResponseOneTwoTicketViewersItemTeamOneCodeMax).describe('コード'),
  "notes": zod.string().max(getWorkflowResponseOneTwoTicketViewersItemTeamOneNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(getWorkflowResponseOneTwoTicketViewersItemTeamOneUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('チーム'),zod.null()]).describe('チーム。ユーザーとチームは片方のみ値が入ります。'),
  "grade": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getWorkflowResponseOneTwoTicketViewersItemGradeOneNameMax).describe('名前'),
  "level": zod.number().min(getWorkflowResponseOneTwoTicketViewersItemGradeOneLevelMin).max(getWorkflowResponseOneTwoTicketViewersItemGradeOneLevelMax).describe('レベル'),
  "code": zod.string().max(getWorkflowResponseOneTwoTicketViewersItemGradeOneCodeMax).nullable().describe('コード'),
  "isDefault": zod.boolean().default(getWorkflowResponseOneTwoTicketViewersItemGradeOneIsDefaultDefault).describe('デフォルトの役職かどうか'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
  ...
  "author": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(getWorkflowResponseTwoRouteConditionsItemRouteOneAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(getWorkflowResponseTwoRouteConditionsItemRouteOneAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(getWorkflowResponseTwoRouteConditionsItemRouteOneAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(getWorkflowResponseTwoRouteConditionsItemRouteOneAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(getWorkflowResponseTwoRouteConditionsItemRouteOneAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(getWorkflowResponseTwoRouteConditionsItemRouteOneAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "versionAuthor": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(getWorkflowResponseTwoRouteConditionsItemRouteOneVersionAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(getWorkflowResponseTwoRouteConditionsItemRouteOneVersionAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(getWorkflowResponseTwoRouteConditionsItemRouteOneVersionAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(getWorkflowResponseTwoRouteConditionsItemRouteOneVersionAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(getWorkflowResponseTwoRouteConditionsItemRouteOneVersionAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(getWorkflowResponseTwoRouteConditionsItemRouteOneVersionAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "folder": zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getWorkflowResponseTwoRouteConditionsItemRouteOneFolderOneNameMax).describe('名前'),
  "code": zod.string().max(getWorkflowResponseTwoRouteConditionsItemRouteOneFolderOneCodeMax).describe('コード'),
  "description": zod.string().nullish().describe('説明'),
  "workflowsCount": zod.number().min(getWorkflowResponseTwoRouteConditionsItemRouteOneFolderOneWorkflowsCountMin).describe('フォルダ内のワークフロー数'),
  "routesCount": zod.number().min(getWorkflowResponseTwoRouteConditionsItemRouteOneFolderOneRoutesCountMin).describe('フォルダ内の経路数'),
  "pipelinesCount": zod.number().min(getWorkflowResponseTwoRouteConditionsItemRouteOneFolderOnePipelinesCountMin).describe('フォルダ内のパイプライン数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('フォルダ').describe('フォルダ')
  ...
  "formField": zod.object({
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemFormFieldOneTitleMax).describe('説明'),
  "description": zod.string().nullable().describe('説明'),
  "fieldType": zod.enum(['text', 'text_long', 'number', 'integer', 'checkbox', 'pull_down', 'date', 'file', 'master', 'user', 'team', 'ticket', 'calculation', 'button_api', 'button_kintone']).describe('フィールドの型'),
  "required": zod.boolean().describe('必須項目かどうか'),
  "approver": zod.boolean().describe('承認者が編集可能かどうか'),
  "author": zod.boolean().optional().describe('申請者が編集可能かどうか'),
  "options": zod.array(zod.string()).nullable().describe('選択肢のリスト。型がcheckboxまたはpull_downのときのみ値が入ります。'),
  "code": zod.string().max(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemFormFieldOneCodeMax).describe('コード'),
  "size": zod.enum(['full', 'half']).describe('フォームサイズ。fullの場合全幅、halfの場合1\/2になります。'),
  "regexpFormat": zod.string().nullable().describe('正規表現フォーマット'),
  "formula": zod.string().nullable().describe('計算式。\n型がcalculationのときのみ値が入ります。'),
  "defaultValue": zod.string().nullable().describe('初期値'),
  "minValue": zod.number().nullable().describe('最小値'),
  "maxValue": zod.number().nullable().describe('最大値'),
  "minLength": zod.number().min(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemFormFieldOneMinLengthMin).nullable().describe('最小文字数'),
  "maxLength": zod.number().min(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemFormFieldOneMaxLengthMin).nullable().describe('最大文字数'),
  "decimalDigit": zod.number().min(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemFormFieldOneDecimalDigitMin).nullable().describe('小数の桁数'),
  "delimited": zod.boolean().nullable().describe('カンマ区切りで表示する場合true。\n整数、数値、自動計算フィールド以外ではnullが入ります。'),
  "prefix": zod.string().nullable().describe('単位（接頭辞）'),
  "suffix": zod.string().nullable().describe('単位（接尾辞）'),
  "hidden": zod.boolean().nullish().describe('隠しフィールドである場合true'),
  ...
  "grade": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemGradeOneNameMax).describe('名前'),
  "level": zod.number().min(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemGradeOneLevelMin).max(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemGradeOneLevelMax).describe('レベル'),
  "code": zod.string().max(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemGradeOneCodeMax).nullable().describe('コード'),
  "isDefault": zod.boolean().default(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemGradeOneIsDefaultDefault).describe('デフォルトの役職かどうか'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('役職'),zod.null()]).describe('しきい値として使う役職'),
  "team": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemTeamOneNameMax).describe('名前'),
  "fullName": zod.string().describe('上位組織を含む名前'),
  "code": zod.string().max(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemTeamOneCodeMax).describe('コード'),
  "notes": zod.string().max(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemTeamOneNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemTeamOneUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('チーム'),zod.null()]).describe('しきい値として使うチーム'),
  "generalMasterItem": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "code": zod.string().max(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemGeneralMasterItemOneCodeMax).describe('コード'),
  "name": zod.string().max(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemGeneralMasterItemOneNameMax).describe('名前'),
  "description": zod.string().nullable().describe('説明'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時'),
  "startsOn": zod.iso.date().nullable().describe('有効期限の開始日'),
  ...
  "field": zod.object({
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemGeneralMasterItemOneInputsItemFieldTitleMax).describe('フィールド名'),
  "description": zod.string().nullable().describe('フィールドの説明'),
  "code": zod.string().max(getWorkflowResponseTwoRouteConditionsItemConditionFieldsItemGeneralMasterItemOneInputsItemFieldCodeMax).describe('フィールドのコード'),
  "fieldType": zod.enum(['text', 'text_long', 'number', 'integer', 'checkbox', 'pull_down', 'date']).describe('フィールドの型'),
  "required": zod.boolean().describe('必須項目かどうか'),
  "visible": zod.boolean().describe('管理者以外も閲覧可能な場合true'),
  "options": zod.array(zod.string()).nullable().describe('選択肢。fieldTypeがcheckboxまたはpull_downのときのみ。'),
