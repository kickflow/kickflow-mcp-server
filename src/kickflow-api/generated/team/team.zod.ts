...
export const CreateTeamResponse = zod.object({
  ...
  "notes": zod.string().max(createTeamResponseOneNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(createTeamResponseOneUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('チーム').and(zod.object({
  "parent": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(createTeamResponseTwoParentOneNameMax).describe('名前'),
  "fullName": zod.string().describe('上位組織を含む名前'),
  "code": zod.string().max(createTeamResponseTwoParentOneCodeMax).describe('コード'),
  "notes": zod.string().max(createTeamResponseTwoParentOneNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(createTeamResponseTwoParentOneUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('チーム'),zod.null()]).optional().describe('親チーム'),
  "children": zod.array(zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(createTeamResponseTwoChildrenItemNameMax).describe('名前'),
  "fullName": zod.string().describe('上位組織を含む名前'),
  "code": zod.string().max(createTeamResponseTwoChildrenItemCodeMax).describe('コード'),
  "notes": zod.string().max(createTeamResponseTwoChildrenItemNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(createTeamResponseTwoChildrenItemUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
  ...
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(createTeamResponseTwoUsersItemOneGradesItemNameMax).describe('名前'),
  "level": zod.number().min(createTeamResponseTwoUsersItemOneGradesItemLevelMin).max(createTeamResponseTwoUsersItemOneGradesItemLevelMax).describe('レベル'),
  "code": zod.string().max(createTeamResponseTwoUsersItemOneGradesItemCodeMax).nullable().describe('コード'),
  "isDefault": zod.boolean().default(createTeamResponseTwoUsersItemOneGradesItemIsDefaultDefault).describe('デフォルトの役職かどうか'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
  ...
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(createTeamResponseTwoUsersItemTwoEmailMax).describe('メールアドレス'),
  "code": zod.string().max(createTeamResponseTwoUsersItemTwoCodeMax).describe('コード'),
  "firstName": zod.string().max(createTeamResponseTwoUsersItemTwoFirstNameMax).describe('名'),
  "lastName": zod.string().max(createTeamResponseTwoUsersItemTwoLastNameMax).describe('姓'),
  "fullName": zod.string().max(createTeamResponseTwoUsersItemTwoFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(createTeamResponseTwoUsersItemTwoEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
...
export const GetTeamResponse = zod.object({
  ...
  "notes": zod.string().max(getTeamResponseOneNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(getTeamResponseOneUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('チーム').and(zod.object({
  "parent": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getTeamResponseTwoParentOneNameMax).describe('名前'),
  "fullName": zod.string().describe('上位組織を含む名前'),
  "code": zod.string().max(getTeamResponseTwoParentOneCodeMax).describe('コード'),
  "notes": zod.string().max(getTeamResponseTwoParentOneNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(getTeamResponseTwoParentOneUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('チーム'),zod.null()]).optional().describe('親チーム'),
  "children": zod.array(zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getTeamResponseTwoChildrenItemNameMax).describe('名前'),
  "fullName": zod.string().describe('上位組織を含む名前'),
  "code": zod.string().max(getTeamResponseTwoChildrenItemCodeMax).describe('コード'),
  "notes": zod.string().max(getTeamResponseTwoChildrenItemNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(getTeamResponseTwoChildrenItemUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('チーム')).describe('子チーム'),
  "users": zod.array(zod.object({
  "grades": zod.array(zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getTeamResponseTwoUsersItemOneGradesItemNameMax).describe('名前'),
  "level": zod.number().min(getTeamResponseTwoUsersItemOneGradesItemLevelMin).max(getTeamResponseTwoUsersItemOneGradesItemLevelMax).describe('レベル'),
  "code": zod.string().max(getTeamResponseTwoUsersItemOneGradesItemCodeMax).nullable().describe('コード'),
  "isDefault": zod.boolean().default(getTeamResponseTwoUsersItemOneGradesItemIsDefaultDefault).describe('デフォルトの役職かどうか'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('役職')).min(1).describe('役職'),
  "leader": zod.boolean().describe('上長かどうか')
  ...
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(getTeamResponseTwoUsersItemTwoEmailMax).describe('メールアドレス'),
  "code": zod.string().max(getTeamResponseTwoUsersItemTwoCodeMax).describe('コード'),
  "firstName": zod.string().max(getTeamResponseTwoUsersItemTwoFirstNameMax).describe('名'),
  "lastName": zod.string().max(getTeamResponseTwoUsersItemTwoLastNameMax).describe('姓'),
  "fullName": zod.string().max(getTeamResponseTwoUsersItemTwoFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(getTeamResponseTwoUsersItemTwoEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
...
export const UpdateTeamResponse = zod.object({
  ...
  "notes": zod.string().max(updateTeamResponseOneNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(updateTeamResponseOneUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('チーム').and(zod.object({
  "parent": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(updateTeamResponseTwoParentOneNameMax).describe('名前'),
  "fullName": zod.string().describe('上位組織を含む名前'),
  "code": zod.string().max(updateTeamResponseTwoParentOneCodeMax).describe('コード'),
  "notes": zod.string().max(updateTeamResponseTwoParentOneNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(updateTeamResponseTwoParentOneUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('チーム'),zod.null()]).optional().describe('親チーム'),
  "children": zod.array(zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(updateTeamResponseTwoChildrenItemNameMax).describe('名前'),
  "fullName": zod.string().describe('上位組織を含む名前'),
  "code": zod.string().max(updateTeamResponseTwoChildrenItemCodeMax).describe('コード'),
  "notes": zod.string().max(updateTeamResponseTwoChildrenItemNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(updateTeamResponseTwoChildrenItemUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('チーム')).describe('子チーム'),
  "users": zod.array(zod.object({
  "grades": zod.array(zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(updateTeamResponseTwoUsersItemOneGradesItemNameMax).describe('名前'),
  "level": zod.number().min(updateTeamResponseTwoUsersItemOneGradesItemLevelMin).max(updateTeamResponseTwoUsersItemOneGradesItemLevelMax).describe('レベル'),
  "code": zod.string().max(updateTeamResponseTwoUsersItemOneGradesItemCodeMax).nullable().describe('コード'),
  "isDefault": zod.boolean().default(updateTeamResponseTwoUsersItemOneGradesItemIsDefaultDefault).describe('デフォルトの役職かどうか'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('役職')).min(1).describe('役職'),
  "leader": zod.boolean().describe('上長かどうか')
  ...
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(updateTeamResponseTwoUsersItemTwoEmailMax).describe('メールアドレス'),
  "code": zod.string().max(updateTeamResponseTwoUsersItemTwoCodeMax).describe('コード'),
  "firstName": zod.string().max(updateTeamResponseTwoUsersItemTwoFirstNameMax).describe('名'),
  "lastName": zod.string().max(updateTeamResponseTwoUsersItemTwoLastNameMax).describe('姓'),
  "fullName": zod.string().max(updateTeamResponseTwoUsersItemTwoFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(updateTeamResponseTwoUsersItemTwoEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
...
export const ListTeamMembersResponseItem = zod.object({
  "grades": zod.array(zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(listTeamMembersResponseOneGradesItemNameMax).describe('名前'),
  "level": zod.number().min(listTeamMembersResponseOneGradesItemLevelMin).max(listTeamMembersResponseOneGradesItemLevelMax).describe('レベル'),
  "code": zod.string().max(listTeamMembersResponseOneGradesItemCodeMax).nullable().describe('コード'),
  "isDefault": zod.boolean().default(listTeamMembersResponseOneGradesItemIsDefaultDefault).describe('デフォルトの役職かどうか'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('役職')).min(1).describe('役職'),
  "leader": zod.boolean().describe('上長かどうか')
  ...
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(listTeamMembersResponseTwoEmailMax).describe('メールアドレス'),
  "code": zod.string().max(listTeamMembersResponseTwoCodeMax).describe('コード'),
  "firstName": zod.string().max(listTeamMembersResponseTwoFirstNameMax).describe('名'),
  "lastName": zod.string().max(listTeamMembersResponseTwoLastNameMax).describe('姓'),
  "fullName": zod.string().max(listTeamMembersResponseTwoFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(listTeamMembersResponseTwoEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
