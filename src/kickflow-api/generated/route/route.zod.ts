...
export const ListRoutesResponseItem = zod.object({
  ...
  "email": zod.email().max(listRoutesResponseAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(listRoutesResponseAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(listRoutesResponseAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(listRoutesResponseAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(listRoutesResponseAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(listRoutesResponseAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  ...
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(listRoutesResponseVersionAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(listRoutesResponseVersionAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(listRoutesResponseVersionAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(listRoutesResponseVersionAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(listRoutesResponseVersionAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(listRoutesResponseVersionAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "folder": zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(listRoutesResponseFolderOneNameMax).describe('名前'),
  "code": zod.string().max(listRoutesResponseFolderOneCodeMax).describe('コード'),
  "description": zod.string().nullish().describe('説明'),
  "workflowsCount": zod.number().min(listRoutesResponseFolderOneWorkflowsCountMin).describe('フォルダ内のワークフロー数'),
  "routesCount": zod.number().min(listRoutesResponseFolderOneRoutesCountMin).describe('フォルダ内の経路数'),
  "pipelinesCount": zod.number().min(listRoutesResponseFolderOnePipelinesCountMin).describe('フォルダ内のパイプライン数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
...
export const GetRouteResponse = zod.object({
  ...
  "author": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(getRouteResponseOneAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(getRouteResponseOneAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(getRouteResponseOneAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(getRouteResponseOneAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(getRouteResponseOneAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(getRouteResponseOneAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "versionAuthor": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(getRouteResponseOneVersionAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(getRouteResponseOneVersionAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(getRouteResponseOneVersionAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(getRouteResponseOneVersionAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(getRouteResponseOneVersionAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(getRouteResponseOneVersionAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "folder": zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getRouteResponseOneFolderOneNameMax).describe('名前'),
  "code": zod.string().max(getRouteResponseOneFolderOneCodeMax).describe('コード'),
  "description": zod.string().nullish().describe('説明'),
  "workflowsCount": zod.number().min(getRouteResponseOneFolderOneWorkflowsCountMin).describe('フォルダ内のワークフロー数'),
  "routesCount": zod.number().min(getRouteResponseOneFolderOneRoutesCountMin).describe('フォルダ内の経路数'),
  "pipelinesCount": zod.number().min(getRouteResponseOneFolderOnePipelinesCountMin).describe('フォルダ内のパイプライン数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('フォルダ').describe('フォルダ')
  ...
  "minCustomAssignees": zod.number().min(getRouteResponseTwoStepsItemMinCustomAssigneesMin).nullable().describe('最小指名人数。「申請者が指名」ステップのみ設定可能。'),
  "approverAssignmentInstruction": zod.string().nullable().describe('承認者の選び方'),
  "users": zod.array(zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(getRouteResponseTwoStepsItemUsersItemEmailMax).describe('メールアドレス'),
  "code": zod.string().max(getRouteResponseTwoStepsItemUsersItemCodeMax).describe('コード'),
  "firstName": zod.string().max(getRouteResponseTwoStepsItemUsersItemFirstNameMax).describe('名'),
  "lastName": zod.string().max(getRouteResponseTwoStepsItemUsersItemLastNameMax).describe('姓'),
  "fullName": zod.string().max(getRouteResponseTwoStepsItemUsersItemFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(getRouteResponseTwoStepsItemUsersItemEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "team": zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getRouteResponseTwoStepsItemTargetsItemTeamNameMax).describe('名前'),
  "fullName": zod.string().describe('上位組織を含む名前'),
  "code": zod.string().max(getRouteResponseTwoStepsItemTargetsItemTeamCodeMax).describe('コード'),
  "notes": zod.string().max(getRouteResponseTwoStepsItemTargetsItemTeamNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(getRouteResponseTwoStepsItemTargetsItemTeamUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
  ...
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getRouteResponseTwoStepsItemTargetsItemGradesItemNameMax).describe('名前'),
  "level": zod.number().min(getRouteResponseTwoStepsItemTargetsItemGradesItemLevelMin).max(getRouteResponseTwoStepsItemTargetsItemGradesItemLevelMax).describe('レベル'),
  "code": zod.string().max(getRouteResponseTwoStepsItemTargetsItemGradesItemCodeMax).nullable().describe('コード'),
  "isDefault": zod.boolean().default(getRouteResponseTwoStepsItemTargetsItemGradesItemIsDefaultDefault).describe('デフォルトの役職かどうか'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
  ...
  "grade": zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemGradeOneNameMax).describe('名前'),
  "level": zod.number().min(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemGradeOneLevelMin).max(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemGradeOneLevelMax).describe('レベル'),
  "code": zod.string().max(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemGradeOneCodeMax).nullable().describe('コード'),
  "isDefault": zod.boolean().default(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemGradeOneIsDefaultDefault).describe('デフォルトの役職かどうか'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('役職').optional().describe('しきい値として使う役職'),
  "team": zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemTeamOneNameMax).describe('名前'),
  "fullName": zod.string().describe('上位組織を含む名前'),
  "code": zod.string().max(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemTeamOneCodeMax).describe('コード'),
  "notes": zod.string().max(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemTeamOneNotesMax).nullish().describe('管理用メモ'),
  "approveOnly": zod.boolean().describe('承認専用チームかどうか'),
  "usersCount": zod.number().min(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemTeamOneUsersCountMin).describe('ユーザー数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('チーム').optional().describe('しきい値として使うチーム'),
  "generalMasterItem": zod.object({
  "id": zod.uuid().describe('UUID'),
  "code": zod.string().max(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemGeneralMasterItemOneCodeMax).describe('コード'),
  "name": zod.string().max(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemGeneralMasterItemOneNameMax).describe('名前'),
  ...
  "field": zod.object({
  "id": zod.uuid().describe('UUID'),
  "title": zod.string().max(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemGeneralMasterItemOneInputsItemFieldTitleMax).describe('フィールド名'),
  "description": zod.string().nullable().describe('フィールドの説明'),
  "code": zod.string().max(getRouteResponseTwoStepsItemRouteStepConditionOneRouteStepConditionFieldsItemGeneralMasterItemOneInputsItemFieldCodeMax).describe('フィールドのコード'),
