...
export const ListGradesResponseItem = zod.object({
  ...
  "isDefault": zod.boolean().default(listGradesResponseIsDefaultDefault).describe('デフォルトの役職かどうか'),
...
export const CreateGradeResponse = zod.object({
  ...
  "isDefault": zod.boolean().default(createGradeResponseIsDefaultDefault).describe('デフォルトの役職かどうか'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('役職')
...
export const GetGradeResponse = zod.object({
  ...
  "isDefault": zod.boolean().default(getGradeResponseIsDefaultDefault).describe('デフォルトの役職かどうか'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('役職')
...
export const UpdateGradeResponse = zod.object({
  ...
  "isDefault": zod.boolean().default(updateGradeResponseIsDefaultDefault).describe('デフォルトの役職かどうか'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('役職')
