...
export const listGradesQuerySortByRegExp = new RegExp(
  '^(level|code)(-asc|-desc)?$',
)
...
export const ListGradesQueryParams = zod.object({
  ...
  sortBy: zod
    .string()
    .regex(listGradesQuerySortByRegExp)
    .optional()
    .describe(
...
export const ListGradesResponseItem = zod
  .object({
...
export const CreateGradeBody = zod
  .object({
...
export const CreateGradeResponse = zod
  .object({
    id: zod.uuid().describe('UUID'),
    ...
    code: zod
      .string()
      .max(createGradeResponseCodeMax)
      .nullable()
      .describe('コード'),
    isDefault: zod
      .boolean()
...
export const GetGradeParams = zod.object({
  gradeId: zod
    .string()
    .regex(getGradePathGradeIdRegExp)
...
export const GetGradeResponse = zod
  .object({
    id: zod.uuid().describe('UUID'),
...
export const DeleteGradeParams = zod.object({
  gradeId: zod
    .string()
    .regex(deleteGradePathGradeIdRegExp)
    .describe('役職のUUIDまたはコード'),
})
...
export const UpdateGradeParams = zod.object({
  gradeId: zod
    .string()
    .regex(updateGradePathGradeIdRegExp)
    .describe('役職のUUIDまたはコード'),
})
...
export const UpdateGradeBody = zod
  .object({
...
export const UpdateGradeResponse = zod
  .object({
    id: zod.uuid().describe('UUID'),
    ...
    code: zod
      .string()
      .max(updateGradeResponseCodeMax)
      .nullable()
      .describe('コード'),
    isDefault: zod
      .boolean()
