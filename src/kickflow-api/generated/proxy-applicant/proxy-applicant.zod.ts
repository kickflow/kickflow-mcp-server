...
export const ListProxyApplicantsResponseItem = zod.object({
  ...
  "publicTicket": zod.boolean().default(listProxyApplicantsResponseWorkflowsItemPublicTicketDefault).describe('チケットがテナント全体に共有される場合true'),
  "visibleToManager": zod.enum(['none', 'direct', 'all']).describe('申請者の上長を共有ユーザーに追加するか。noneは追加しない、directは直属の上長のみ、allはすべての上長を表す。'),
  "visibleToTeamMembers": zod.boolean().default(listProxyApplicantsResponseWorkflowsItemVisibleToTeamMembersDefault).describe('申請チームのメンバーが共有ユーザーに追加される場合true'),
  ...
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(listProxyApplicantsResponseWorkflowsItemAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(listProxyApplicantsResponseWorkflowsItemAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(listProxyApplicantsResponseWorkflowsItemAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(listProxyApplicantsResponseWorkflowsItemAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(listProxyApplicantsResponseWorkflowsItemAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(listProxyApplicantsResponseWorkflowsItemAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(listProxyApplicantsResponseWorkflowsItemVersionAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(listProxyApplicantsResponseWorkflowsItemVersionAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(listProxyApplicantsResponseWorkflowsItemVersionAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(listProxyApplicantsResponseWorkflowsItemVersionAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(listProxyApplicantsResponseWorkflowsItemVersionAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(listProxyApplicantsResponseWorkflowsItemVersionAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "folder": zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(listProxyApplicantsResponseWorkflowsItemFolderOneNameMax).describe('名前'),
  "code": zod.string().max(listProxyApplicantsResponseWorkflowsItemFolderOneCodeMax).describe('コード'),
  "description": zod.string().nullish().describe('説明'),
  "workflowsCount": zod.number().min(listProxyApplicantsResponseWorkflowsItemFolderOneWorkflowsCountMin).describe('フォルダ内のワークフロー数'),
  "routesCount": zod.number().min(listProxyApplicantsResponseWorkflowsItemFolderOneRoutesCountMin).describe('フォルダ内の経路数'),
  "pipelinesCount": zod.number().min(listProxyApplicantsResponseWorkflowsItemFolderOnePipelinesCountMin).describe('フォルダ内のパイプライン数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
...
export const CreateProxyApplicantResponse = zod.object({
  ...
  "description": zod.string().describe('説明'),
  "status": zod.enum(['visible', 'invisible', 'deleted']).describe('ステータス。visibleは有効、invisibleは無効、deletedは削除済み。'),
  "publicTicket": zod.boolean().default(createProxyApplicantResponseWorkflowsItemPublicTicketDefault).describe('チケットがテナント全体に共有される場合true'),
  "visibleToManager": zod.enum(['none', 'direct', 'all']).describe('申請者の上長を共有ユーザーに追加するか。noneは追加しない、directは直属の上長のみ、allはすべての上長を表す。'),
  "visibleToTeamMembers": zod.boolean().default(createProxyApplicantResponseWorkflowsItemVisibleToTeamMembersDefault).describe('申請チームのメンバーが共有ユーザーに追加される場合true'),
  "titleDescription": zod.string().nullable().describe('タイトルの説明'),
  "ticketNumberFormat": zod.string().nullable().describe('チケット番号のフォーマット'),
  "overwritable": zod.boolean().describe('承認者による上書きが可能な場合true'),
  "createdAt": zod.string().describe('作成日時'),
  ...
  "author": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(createProxyApplicantResponseWorkflowsItemAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(createProxyApplicantResponseWorkflowsItemAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(createProxyApplicantResponseWorkflowsItemAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(createProxyApplicantResponseWorkflowsItemAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(createProxyApplicantResponseWorkflowsItemAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(createProxyApplicantResponseWorkflowsItemAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "versionAuthor": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(createProxyApplicantResponseWorkflowsItemVersionAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(createProxyApplicantResponseWorkflowsItemVersionAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(createProxyApplicantResponseWorkflowsItemVersionAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(createProxyApplicantResponseWorkflowsItemVersionAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(createProxyApplicantResponseWorkflowsItemVersionAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(createProxyApplicantResponseWorkflowsItemVersionAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "folder": zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(createProxyApplicantResponseWorkflowsItemFolderOneNameMax).describe('名前'),
  "code": zod.string().max(createProxyApplicantResponseWorkflowsItemFolderOneCodeMax).describe('コード'),
  "description": zod.string().nullish().describe('説明'),
  "workflowsCount": zod.number().min(createProxyApplicantResponseWorkflowsItemFolderOneWorkflowsCountMin).describe('フォルダ内のワークフロー数'),
  "routesCount": zod.number().min(createProxyApplicantResponseWorkflowsItemFolderOneRoutesCountMin).describe('フォルダ内の経路数'),
  "pipelinesCount": zod.number().min(createProxyApplicantResponseWorkflowsItemFolderOnePipelinesCountMin).describe('フォルダ内のパイプライン数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('フォルダ').describe('フォルダ'),
  "categories": zod.array(zod.object({
