...
export const ListProxyApproversResponseItem = zod.object({
  ...
  "publicTicket": zod.boolean().default(listProxyApproversResponseWorkflowsItemPublicTicketDefault).describe('チケットがテナント全体に共有される場合true'),
  "visibleToManager": zod.enum(['none', 'direct', 'all']).describe('申請者の上長を共有ユーザーに追加するか。noneは追加しない、directは直属の上長のみ、allはすべての上長を表す。'),
  "visibleToTeamMembers": zod.boolean().default(listProxyApproversResponseWorkflowsItemVisibleToTeamMembersDefault).describe('申請チームのメンバーが共有ユーザーに追加される場合true'),
  ...
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(listProxyApproversResponseWorkflowsItemAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(listProxyApproversResponseWorkflowsItemAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(listProxyApproversResponseWorkflowsItemAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(listProxyApproversResponseWorkflowsItemAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(listProxyApproversResponseWorkflowsItemAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(listProxyApproversResponseWorkflowsItemAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(listProxyApproversResponseWorkflowsItemVersionAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(listProxyApproversResponseWorkflowsItemVersionAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(listProxyApproversResponseWorkflowsItemVersionAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(listProxyApproversResponseWorkflowsItemVersionAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(listProxyApproversResponseWorkflowsItemVersionAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(listProxyApproversResponseWorkflowsItemVersionAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "folder": zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(listProxyApproversResponseWorkflowsItemFolderOneNameMax).describe('名前'),
  "code": zod.string().max(listProxyApproversResponseWorkflowsItemFolderOneCodeMax).describe('コード'),
  "description": zod.string().nullish().describe('説明'),
  "workflowsCount": zod.number().min(listProxyApproversResponseWorkflowsItemFolderOneWorkflowsCountMin).describe('フォルダ内のワークフロー数'),
  "routesCount": zod.number().min(listProxyApproversResponseWorkflowsItemFolderOneRoutesCountMin).describe('フォルダ内の経路数'),
  "pipelinesCount": zod.number().min(listProxyApproversResponseWorkflowsItemFolderOnePipelinesCountMin).describe('フォルダ内のパイプライン数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
...
export const CreateProxyApproverResponse = zod.object({
  ...
  "description": zod.string().describe('説明'),
  "status": zod.enum(['visible', 'invisible', 'deleted']).describe('ステータス。visibleは有効、invisibleは無効、deletedは削除済み。'),
  "publicTicket": zod.boolean().default(createProxyApproverResponseWorkflowsItemPublicTicketDefault).describe('チケットがテナント全体に共有される場合true'),
  "visibleToManager": zod.enum(['none', 'direct', 'all']).describe('申請者の上長を共有ユーザーに追加するか。noneは追加しない、directは直属の上長のみ、allはすべての上長を表す。'),
  "visibleToTeamMembers": zod.boolean().default(createProxyApproverResponseWorkflowsItemVisibleToTeamMembersDefault).describe('申請チームのメンバーが共有ユーザーに追加される場合true'),
  "titleDescription": zod.string().nullable().describe('タイトルの説明'),
  "ticketNumberFormat": zod.string().nullable().describe('チケット番号のフォーマット'),
  "overwritable": zod.boolean().describe('承認者による上書きが可能な場合true'),
  "createdAt": zod.string().describe('作成日時'),
  ...
  "author": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(createProxyApproverResponseWorkflowsItemAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(createProxyApproverResponseWorkflowsItemAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(createProxyApproverResponseWorkflowsItemAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(createProxyApproverResponseWorkflowsItemAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(createProxyApproverResponseWorkflowsItemAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(createProxyApproverResponseWorkflowsItemAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "versionAuthor": zod.union([zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(createProxyApproverResponseWorkflowsItemVersionAuthorOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(createProxyApproverResponseWorkflowsItemVersionAuthorOneCodeMax).describe('コード'),
  "firstName": zod.string().max(createProxyApproverResponseWorkflowsItemVersionAuthorOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(createProxyApproverResponseWorkflowsItemVersionAuthorOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(createProxyApproverResponseWorkflowsItemVersionAuthorOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(createProxyApproverResponseWorkflowsItemVersionAuthorOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
  ...
  "folder": zod.object({
  "id": zod.uuid().describe('UUID'),
  "name": zod.string().max(createProxyApproverResponseWorkflowsItemFolderOneNameMax).describe('名前'),
  "code": zod.string().max(createProxyApproverResponseWorkflowsItemFolderOneCodeMax).describe('コード'),
  "description": zod.string().nullish().describe('説明'),
  "workflowsCount": zod.number().min(createProxyApproverResponseWorkflowsItemFolderOneWorkflowsCountMin).describe('フォルダ内のワークフロー数'),
  "routesCount": zod.number().min(createProxyApproverResponseWorkflowsItemFolderOneRoutesCountMin).describe('フォルダ内の経路数'),
  "pipelinesCount": zod.number().min(createProxyApproverResponseWorkflowsItemFolderOnePipelinesCountMin).describe('フォルダ内のパイプライン数'),
  "createdAt": zod.iso.datetime({}).describe('作成日時'),
  "updatedAt": zod.iso.datetime({}).describe('更新日時')
}).describe('フォルダ').describe('フォルダ'),
  "categories": zod.array(zod.object({
