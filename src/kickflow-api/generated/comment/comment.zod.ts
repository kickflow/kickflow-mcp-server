...
export const ListCommentsResponseItem = zod.object({
  ...
  "user": zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(listCommentsResponseUserOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(listCommentsResponseUserOneCodeMax).describe('コード'),
  "firstName": zod.string().max(listCommentsResponseUserOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(listCommentsResponseUserOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(listCommentsResponseUserOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(listCommentsResponseUserOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
...
export const CreateCommentResponse = zod.object({
  ...
  "user": zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(createCommentResponseUserOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(createCommentResponseUserOneCodeMax).describe('コード'),
  "firstName": zod.string().max(createCommentResponseUserOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(createCommentResponseUserOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(createCommentResponseUserOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(createCommentResponseUserOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
...
export const GetCommentResponse = zod.object({
  ...
  "user": zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(getCommentResponseUserOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(getCommentResponseUserOneCodeMax).describe('コード'),
  "firstName": zod.string().max(getCommentResponseUserOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(getCommentResponseUserOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(getCommentResponseUserOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(getCommentResponseUserOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
...
export const UpdateCommentResponse = zod.object({
  ...
  "user": zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(updateCommentResponseUserOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(updateCommentResponseUserOneCodeMax).describe('コード'),
  "firstName": zod.string().max(updateCommentResponseUserOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(updateCommentResponseUserOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(updateCommentResponseUserOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(updateCommentResponseUserOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
