...
export const GetCurrentUserResponse = zod.object({
  ...
  "email": zod.email().max(getCurrentUserResponseOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(getCurrentUserResponseOneCodeMax).describe('コード'),
  "firstName": zod.string().max(getCurrentUserResponseOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(getCurrentUserResponseOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(getCurrentUserResponseOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(getCurrentUserResponseOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
...
export const CreateUserResponse = zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(createUserResponseOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(createUserResponseOneCodeMax).describe('コード'),
  "firstName": zod.string().max(createUserResponseOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(createUserResponseOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(createUserResponseOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(createUserResponseOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
...
export const GetUserResponse = zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(getUserResponseOneEmailMax).describe('メールアドレス'),
  ...
  "fullName": zod.string().max(getUserResponseOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(getUserResponseOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
...
export const DeleteUserResponse = zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(deleteUserResponseOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(deleteUserResponseOneCodeMax).describe('コード'),
  "firstName": zod.string().max(deleteUserResponseOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(deleteUserResponseOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(deleteUserResponseOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(deleteUserResponseOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
...
export const UpdateUserResponse = zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(updateUserResponseOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(updateUserResponseOneCodeMax).describe('コード'),
  "firstName": zod.string().max(updateUserResponseOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(updateUserResponseOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(updateUserResponseOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(updateUserResponseOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
...
export const LookupUserByEmailResponse = zod.object({
  "id": zod.uuid().describe('UUID'),
  "email": zod.email().max(lookupUserByEmailResponseOneEmailMax).describe('メールアドレス'),
  "code": zod.string().max(lookupUserByEmailResponseOneCodeMax).describe('コード'),
  "firstName": zod.string().max(lookupUserByEmailResponseOneFirstNameMax).describe('名'),
  "lastName": zod.string().max(lookupUserByEmailResponseOneLastNameMax).describe('姓'),
  "fullName": zod.string().max(lookupUserByEmailResponseOneFullNameMax).describe('フルネーム'),
  "employeeId": zod.string().max(lookupUserByEmailResponseOneEmployeeIdMax).nullish().describe('社員番号'),
  "image": zod.object({
  "100x100": zod.string().nullable(),
  "64x64": zod.string().nullable(),
  "32x32": zod.string().nullable()
