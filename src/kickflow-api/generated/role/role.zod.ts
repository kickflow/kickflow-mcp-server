...
export const listRolesQuerySortByRegExp = new RegExp(
                ...
                zod
                  .object({
                    ...
                    code: zod
                      .string()
                      .max(
                        createRoleResponseTwoPermissionListItemGeneralMastersItemCodeMax,
                      )
                      .describe('コード'),
                    name: zod
                      .string()
                        ...
                        zod
                          .object({
                            ...
                            title: zod
                              .string()
                              .max(
                                createRoleResponseTwoPermissionListItemGeneralMastersItemFieldsItemTitleMax,
                              )
                              .describe('フィールド名'),
                            description: zod
                              .string()
                            ...
                            code: zod
                              .string()
                              .max(
                                createRoleResponseTwoPermissionListItemGeneralMastersItemFieldsItemCodeMax,
                              )
                              .describe('フィールドのコード'),
                            fieldType: zod
                              .enum([
                ...
                zod
                  .object({
                    ...
                    name: zod
                      .string()
                      .max(
                        createRoleResponseTwoPermissionListItemTeamsItemNameMax,
                      )
                      .describe('名前'),
                    ...
                    code: zod
                      .string()
                      .max(
                        createRoleResponseTwoPermissionListItemTeamsItemCodeMax,
                      )
                      .describe('コード'),
                    notes: zod
                      .string()
                ...
                zod
                  .object({
                    ...
                    code: zod
                      .string()
                      .max(
                        getRoleResponseTwoPermissionListItemGeneralMastersItemCodeMax,
                      )
                      .describe('コード'),
                    name: zod
                      .string()
                        ...
                        zod
                          .object({
                            ...
                            title: zod
                              .string()
                              .max(
                                getRoleResponseTwoPermissionListItemGeneralMastersItemFieldsItemTitleMax,
                              )
                              .describe('フィールド名'),
                            description: zod
                              .string()
                            ...
                            code: zod
                              .string()
                              .max(
                                getRoleResponseTwoPermissionListItemGeneralMastersItemFieldsItemCodeMax,
                              )
                              .describe('フィールドのコード'),
                            fieldType: zod
                              .enum([
                ...
                zod
                  .object({
                    ...
                    code: zod
                      .string()
                      .max(
                        updateRoleResponseTwoPermissionListItemGeneralMastersItemCodeMax,
                      )
                      .describe('コード'),
                    name: zod
                      .string()
                        ...
                        zod
                          .object({
                            ...
                            title: zod
                              .string()
                              .max(
                                updateRoleResponseTwoPermissionListItemGeneralMastersItemFieldsItemTitleMax,
                              )
                              .describe('フィールド名'),
                            description: zod
                              .string()
                            ...
                            code: zod
                              .string()
                              .max(
                                updateRoleResponseTwoPermissionListItemGeneralMastersItemFieldsItemCodeMax,
                              )
                              .describe('フィールドのコード'),
                            fieldType: zod
                              .enum([
                ...
                zod
                  .object({
                    ...
                    name: zod
                      .string()
                      .max(
                        updateRoleResponseTwoPermissionListItemTeamsItemNameMax,
                      )
                      .describe('名前'),
                    fullName: zod.string().describe('上位組織を含む名前'),
                    code: zod
                      .string()
                      .max(
                        updateRoleResponseTwoPermissionListItemTeamsItemCodeMax,
                      )
                      .describe('コード'),
                    notes: zod
                      .string()
