...
export const listGeneralMastersQuerySortByRegExp = new RegExp(
  '^(createdAt|code|name)(-asc|-desc)?$',
)
...
export const ListGeneralMastersResponseItem = zod
  .object({
    ...
    initialDisplayCreatedAt: zod.boolean().describe('作成日時を初期表示するか'),
    initialDisplayDescription: zod.boolean().describe('説明を初期表示するか'),
  ...
  .describe('汎用マスタ')
export const ListGeneralMastersResponse = zod.array(
  ListGeneralMastersResponseItem,
)
...
export const listGeneralMasterItemsQuerySortByRegExp = new RegExp(
  '^(createdAt|code|name)(-asc|-desc)?$',
)
...
export const ListGeneralMasterItemsResponseItem = zod
  ...
  .describe('汎用マスタのアイテム')
export const ListGeneralMasterItemsResponse = zod.array(
  ListGeneralMasterItemsResponseItem,
)
